...
#Run this if it is your first time and you may not have all of the necessary packages.
...
load_packages <- function(pkgs) {
  ...
  if (any(!res)) {
    warning("Could not load: ", paste(pkgs[!res], collapse = ", "))
  }
  invisible(res)
}
...
Although not shown in my thesis, 
