...
The following section will describe the steps undertaken for intiial differential expression analysis, with the goal of producing: 1. Normalized counts 2. Principal component analysis 3. Significantly diferentially expressed gene lists
...
```         
In this case, I have implemented a function to generate meta data based on the investigation I am performing so as to keep the global environment neat.
```
...
Further style changes were made in an external vector editor to increase figure legibility, these include: - Adding of ellipses bounding points - Adjustments to color scheme - Omission of cocktail group
